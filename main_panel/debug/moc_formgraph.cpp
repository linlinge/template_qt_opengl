...
const QMetaObject FormGraph::staticMetaObject = {
    { &QOpenGLWindow::staticMetaObject, qt_meta_stringdata_FormGraph.data,
      qt_meta_data_FormGraph,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FormGraph::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FormGraph.stringdata0))
        return static_cast<void*>(const_cast< FormGraph*>(this));
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< FormGraph*>(this));
