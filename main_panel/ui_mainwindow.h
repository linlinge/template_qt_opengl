...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(1130, 672);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        horizontalLayoutWidget = new QWidget(centralWidget);
        horizontalLayoutWidget->setObjectName(QStringLiteral("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(10, 10, 1111, 601));
        pHBoxLayout = new QHBoxLayout(horizontalLayoutWidget);
        pHBoxLayout->setSpacing(6);
        pHBoxLayout->setContentsMargins(11, 11, 11, 11);
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "PCLab", Q_NULLPTR));
